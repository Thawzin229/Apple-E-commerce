...
<div class="mdl-card mdl-shadow--2dp">
                    <div class="mdl-card__title" id="title">
                        <h1 class="mdl-card__title-text">Ipad product table
                          <span class="mx-2"><i class="zmdi zmdi-tablet-mac"></i></span>
                        </h1>
                        <form action="{{ route('admin#ipadpage') }}" method="get">
                          @csrf
                ...
                <div class="mdl-textfield__expandable-holder">
                    ...
                    <label class="mdl-textfield__label" for="search">Enter your query...</label>
                        ...
                        <td class="mdl-data-table__cell--non-numeric"><a href="{{ route('admin#createipadpage') }}"><button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal">Add ipad</button></a></td>
                    </div>
