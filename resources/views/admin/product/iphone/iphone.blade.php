...
<div class="mdl-card mdl-shadow--2dp">
                ...
                <div class="mdl-textfield__expandable-holder">
                    ...
                    <label class="mdl-textfield__label" for="search">Enter your query...</label>
                        ...
                        <td class="mdl-data-table__cell--non-numeric"><a href="{{ route('admin#createiphonepage') }}"><button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect button--colored-teal">Add iphone</button></a></td>
                    </div>
                            ...
                            @foreach($data as $item)
                              <tr>
                                ...
                                <td class="mdl-data-table__cell--non-numeric text-center">
                                  ...
                                  <a href="{{ route('admin#updatepage',$item['id']) }}" class="text-decoration-none text-light "><span class="label label--mini background-color--primary p-3" ><i class="zmdi zmdi-border-color ms-2"></i>Edit</span></a>
                              </td>
                            </tr>
                              @endforeach
                              @else
