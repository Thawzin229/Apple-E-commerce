...
class ContactController extends Controller
{
    ...
    public function contact(){
        ...
        return view("customer.contactus.contactus",compact("categories","cartdata","data","iphonedata","macbookdata","iwatchdata","ipaddata","teamdata","feedbackdata"));
    }

    //contact data 
    public function contactData(Request $data){
