                                    ...
                                    <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                        <div class="dash__pad-3">
                                            ...
                                            <div class="dash__link dash__link--secondary u-s-m-b-8">
                                                ...
                                                <a href="{{ route('customer#editaccpage') }}">Edit</a></div>
                                            ...
                                            <div class="dash__link dash__link--secondary u-s-m-t-8">
                                                ...
                                                <a data-modal="modal" data-modal-id="#dash-newsletter"></a></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-5 u-s-m-b-30">
                                    <div class="dash__box dash__box--bg-grey dash__box--shadow-2 u-h-100">
                                        <div class="dash__pad-3">
                                            ...
                                            <div class="dash__link dash__link--secondary u-s-m-b-8">
                                                ...
                                                <a href="{{ route('customer#accountaddresspage') }}">View address history</a></div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="dash__table-total">
                                                ...
                                                <span>{{ $item['totalprice'] }} Kyats</span>
