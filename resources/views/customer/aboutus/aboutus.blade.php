                ...
                <div class="breadcrumb__wrap">
                    <ul class="breadcrumb__list">
                        ...
                        <li class="is-marked">
                            ...
                            <a href="{{ route('customer#aboutuspage') }}">About</a></li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="about">
                        <div class="about__container">
                            <div class="about__info">
                                ...
                                <a class="about__link btn--e-secondary" href="{{ route('customer#allproduct') }}">Shop Now</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<section>
    <div class="col-12">
        <img class="w-100" src="{{ asset('applecare.png') }}" alt="">
    </div>
</section>
                    ...
                    <div class="team-member u-h-100">
                        <div class="team-member__wrap">
                            <div class="aspect aspect--bg-grey-fb aspect--square">
                                ...
                                <img class="aspect__img team-member__img" src="{{ asset('storage/'.$item['image']) }}" alt=""></div>
                        ...
                        <div class="team-member__info">
                            ...
                            <span class="team-member__name">{{ $item['name'] }}</span>

                            <span class="team-member__job-title">{{ $item['career'] }}</span></div>
                    </div>
                </div>
                @endforeach
            </div>
...
<section class="my-5">
    <div class="col-12">
        <img class="w-100" src="{{ asset('member.jpeg') }}" alt="">
    </div>
</section>
<!--====== Section 4 ======-->
